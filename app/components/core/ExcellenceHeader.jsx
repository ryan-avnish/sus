...
<div id="navbx">
   <div className="heading"><Link to="/">Home</Link></div>
    <ul>
       ...
       <li><Link to={this.getLink("/glance")} ><img src="static/images/glance.png"/> At a Glance <i className="fa fa-chevron-right" aria-hidden="true"></i></Link></li>
       <li><Link to={this.getLink("http://zgu8tz.axshare.com/#g=1&p=overview")} target="_blank"><img src="static/images/analysis_icn.png"/> Analysis <i className="fa fa-chevron-right" aria-hidden="true"></i></Link></li>
