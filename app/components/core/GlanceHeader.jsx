  ...
  render() {
    return (
      ...
      <nav id="topNav" className="navbar navbar-default navbar-fixed-top bg-blue">
        ...
        <div className="col-md-2 col-xs-2"><div id="mobile-nav" ><Link to="/"><img src="static/images/menu_icon_nw.png"/></Link></div></div>
    ...
    <ul className="dropdown-menu">
      ...
      <li><a href="#">2017</a></li>
              ...
              <div className="heading_text">
                  <h2>SUS Metrics Performance At-A-Glance</h2>
              </div>  
        </div>
    ...
    <ul>
       <li>
          ...
          <ul style={{'display': 'none', 'overflowX': 'visible', 'overflowY': 'visible'}}>
            <li><Link onClick={this.changeTabClass}  to="/excellence">Excellence</Link></li>
            <li><Link onClick={this.changeTabClass1} to="/improvement">Improvement</Link></li>
            <li><Link onClick={this.changeTabClass2} to="/funding">Funding</Link></li>
          </ul>
       </li>
       <li className="active" ><Link to="/glance" ><img src="static/images/glance.png"/> At a Glance <i className="fa fa-chevron-right" aria-hidden="true"></i></Link></li>
